...
open class QuotaRequestsAPI {
     ...
     */
    @discardableResult
    open class func apiAdminRequestsCreate(quotaRequest: QuotaRequest, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: QuotaRequest?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func apiAdminRequestsCreateWithRequestBuilder(quotaRequest: QuotaRequest) -> RequestBuilder<QuotaRequest> {
        ...
        let localVariableRequestBuilder: RequestBuilder<QuotaRequest>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func apiAdminRequestsDestroy(id: Int, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func apiAdminRequestsDetailsRetrieve(id: Int, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: QuotaRequestDetail?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func apiAdminRequestsDetailsRetrieveWithRequestBuilder(id: Int) -> RequestBuilder<QuotaRequestDetail> {
        ...
        let localVariableRequestBuilder: RequestBuilder<QuotaRequestDetail>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func apiAdminRequestsList(apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: [QuotaRequest]?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func apiAdminRequestsPartialUpdate(id: Int, patchedQuotaRequest: PatchedQuotaRequest? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: QuotaRequest?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func apiAdminRequestsRetrieve(id: Int, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: QuotaRequest?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func apiAdminRequestsUpdate(id: Int, quotaRequest: QuotaRequest, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: QuotaRequest?, _ error: Error?) -> Void)) -> RequestTask {
