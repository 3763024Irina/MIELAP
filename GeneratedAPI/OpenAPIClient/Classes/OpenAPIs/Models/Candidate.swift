...
public struct Candidate: Codable, JSONEncodable, Hashable {
    ...
    public init(id: Int, age: Int, officeName: String, courses: [Course], coursesIds: [Int]? = nil, birth: String? = nil, isArchive: Bool? = nil, name: String, surname: String, patronymic: String? = nil, education: String? = nil, photo: String? = nil, country: String? = nil, city: String? = nil, email: String?, phone: String, resume: String? = nil, agreement: String? = nil, isFree: Bool? = nil, achivmentObjects: Int? = nil, achivmentClients: Int? = nil, achivmentLeads: Int? = nil, achivmentExclusives: Int? = nil, achivmentDeals: Int? = nil, createdAt: Date, updatedAt: Date, office: Int? = nil) {
        self.id = id
        self.age = age
