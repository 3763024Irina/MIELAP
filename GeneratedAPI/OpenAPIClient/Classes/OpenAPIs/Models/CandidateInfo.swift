...
public struct CandidateInfo: Codable, JSONEncodable, Hashable {
    ...
    public init(id: Int, name: String, surname: String, patronymic: String? = nil, birth: Date?, age: Int, education: String? = nil, photo: String? = nil, country: String? = nil, city: String? = nil, resume: String? = nil, courses: [Course], updatedAt: Date, isFavorite: Bool, favoriteId: Int, isInvited: Bool, achivmentObjects: Int? = nil, achivmentClients: Int? = nil, achivmentLeads: Int? = nil, achivmentExclusives: Int? = nil, achivmentDeals: Int? = nil) {
        self.id = id
        self.name = name
